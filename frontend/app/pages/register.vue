...
<template>
    <div class="pt-6 w-full flex items-center justify-center px-4">
        <div class="w-full max-w-[440px]">
                ...
                <div class="p-6 md:p-8 space-y-4">
                    ...
                    <form class="space-y-3" @submit.prevent="handleRegister">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative group">
                                ...
                                <input
                                    ...
                                    class="w-full rounded-lg bg-surface-container border border-outline-variant/40
                                    text-on-surface-variant placeholder:text-on-surface-variant/50
                                    py-3 pl-10 pr-4
                                    focus:outline-none focus:ring-1 focus:ring-primary-container focus:border-primary-container"
                                />
                            </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative group">
                                <Icon name="material-symbols:badge-outline"
                                    class="absolute left-3 top-1/2 -translate-y-1/2 text-on-surface-variant group-focus-within:text-primary-container transition-colors" />
                        ...
                        <div class="space-y-2">
                            <label class="text-sm text-on-surface-variant">Пароль</label>
                        ...
                        <div class="space-y-2">
                            <label class="text-sm text-on-surface-variant">Повтор пароля</label>
            ...
            <p class="my-6 text-center text-sm text-on-surface-variant">
                Уже есть аккаунт?
                <NuxtLink to="/login" class="text-primary hover:text-primary-container transition-colors">
                    Войти
                </NuxtLink>
            </p>
